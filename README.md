...
A Opinionated Hyprland desktop iterated from yahr-quickshell. Includes a unified theme system that syncs colours across every application simultaneously, 14 built-in colour schemes, a custom bar, app launcher, calendar, power menu, wallpaper picker, and more.
